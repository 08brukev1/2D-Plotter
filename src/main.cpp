...
void newLine()
{
  ...
  while (!digitalRead(Sensor1))
  {
    moveXY_DDA(-1, 0, STEP_DELAY_US);
  }
  moveXY_DDA(0, -LINE_H, STEP_DELAY_US);
  currentX = 0.0;
}
...
void draw0()
{
  ...
  drawArc(r, 0, PI, 20, STEP_DELAY_US);
  moveXY_DDA(0, -LETTER_H / 3, STEP_DELAY_US);
  penUp();
  moveXY_DDA(2 * r + SPACE_W, -r, STEP_DELAY_US);
}
...
{
  penDown();
  moveXY_DDA(0.1, -0.15, STEP_DELAY_US);
  penUp();
  moveXY_DDA(SPACE_W, 0.15, STEP_DELAY_US);
}
...
void drawColon()
{
  ...
  penDown();
  moveXY_DDA(0, 0.06, STEP_DELAY_US);
  penUp();
  moveXY_DDA(0, LETTER_H / 4, STEP_DELAY_US);
  penDown();
  moveXY_DDA(0, 0.06, STEP_DELAY_US);
  penUp();
  moveXY_DDA(SPACE_W, -(LETTER_H / 2 + 0.14), STEP_DELAY_US);
}
...
void drawEqual()
{
  moveXY_DDA(0, LETTER_H / 4, STEP_DELAY_US);
  penDown();
  moveXY_DDA(LETTER_W / 3, 0, STEP_DELAY_US);
  penUp();
  moveXY_DDA(-LETTER_W / 3, LETTER_H / 6, STEP_DELAY_US);
  penDown();
  moveXY_DDA(LETTER_W / 3, 0, STEP_DELAY_US);
  penUp();
  moveXY_DDA(SPACE_W, -(LETTER_H / 4 + LETTER_H / 6), STEP_DELAY_US);
}
...
void drawPlus()
{
  ...
  moveXY_DDA(LETTER_W / 3, 0, STEP_DELAY_US);
  penUp();
  moveXY_DDA(-LETTER_W / 6, LETTER_H / 6, STEP_DELAY_US);
  penDown();
  moveXY_DDA(0, -LETTER_H / 3, STEP_DELAY_US);
  penUp();
  moveXY_DDA(LETTER_W / 6 + SPACE_W, -(LETTER_H / 2 - LETTER_H / 4), STEP_DELAY_US);
}
...
{
  penDown();
  moveXY_DDA(LETTER_W / 2, LETTER_H, STEP_DELAY_US);
  penUp();
  moveXY_DDA(SPACE_W, -LETTER_H, STEP_DELAY_US);
}
void drawPercent()
{
  ...
  penDown();
  drawArc(0.05, 0, 2 * PI, 20, STEP_DELAY_US);
  penUp();
  moveXY_DDA(LETTER_W / 2, -(LETTER_H - 0.1), STEP_DELAY_US);
  penDown();
  drawArc(0.05, 0, 2 * PI, 20, STEP_DELAY_US);
  penUp();
  moveXY_DDA(SPACE_W, 0, STEP_DELAY_US);
...
void drawQuote()
{
  ...
  penUp();
  moveXY_DDA(SPACE_W / 2, LETTER_H * 0.2, STEP_DELAY_US);
  penDown();
  moveXY_DDA(0, -LETTER_H * 0.2, STEP_DELAY_US);
  penUp();
  moveXY_DDA(SPACE_W, -LETTER_H * 0.8, STEP_DELAY_US);
}
...
void drawB()
{
  ...
  moveXY_DDA(-LETTER_W / 6, 0, 1000);
  penUp();
  moveXY_DDA(SPACE_W + LETTER_W / 6 + r, 0, 1000);
}
...
void drawT()
{
  ...
  moveXY_DDA(0, -LETTER_H, 1000);
  penUp();
  moveXY_DDA(LETTER_W / 2.3 + SPACE_W, 0, 1000);
}
void drawU()
{
  float r = LETTER_W / 2;
...
void drawZ()
{
  ...
  moveXY_DDA(-LETTER_W, 0, 1000);
  penUp();
  moveXY_DDA(SPACE_W + LETTER_W, -LETTER_H, 1000);
}
...
void drawa()
{
  ...
  penUp();
  moveXY_DDA(SPACE_W, -LETTER_H * 0.6, STEP_DELAY_US);
}
...
void drawc()
{
  ...
  penUp();
  moveXY_DDA(SPACE_W, -0.1, STEP_DELAY_US);
}
...
void drawi()
{
  ...
  penUp();
  moveXY_DDA(SPACE_W, -(LETTER_H * 0.5 + LETTER_H / 4), STEP_DELAY_US);
}
...
void drawj()
{
  ...
  moveXY_DDA(0, LETTER_H * 0.05, STEP_DELAY_US); // Punkt
  penUp();
  moveXY_DDA(SPACE_W, -(LETTER_H * 0.5 + LETTER_H / 4 + r), STEP_DELAY_US);
}
...
{
  penUp();
  moveXY_DDA(SPACE_W * 1.5, 0, STEP_DELAY_US);
  float r = LETTER_H / 4;
  penDown();
  moveXY_DDA(-LETTER_W / 6, 0, 1000);
...
void drawr()
{
  ...
  drawArc(r, PI, PI * 0.1, 20, STEP_DELAY_US); // kurzer Schulter-Bogen
  penUp();
  moveXY_DDA(SPACE_W, -LETTER_H * 0.45, STEP_DELAY_US);
}
...
void drawt()
{
  ...
  penUp();
  moveXY_DDA(LETTER_W * 0.1, LETTER_H, STEP_DELAY_US);
  penDown();
  moveXY_DDA(0, -(LETTER_H - r), STEP_DELAY_US);
  drawArc(r, PI, 2 * PI, 15, STEP_DELAY_US); // Fußhaken
  penUp();
  moveXY_DDA(-LETTER_W * 0.3 - r, LETTER_H * 0.65, STEP_DELAY_US);
  penDown();
  moveXY_DDA(LETTER_W * 0.5, 0, STEP_DELAY_US); // Querstrich
  penUp();
  moveXY_DDA(r + SPACE_W, -LETTER_H * 0.7, STEP_DELAY_US);
}
